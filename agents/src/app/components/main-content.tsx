...
const tableData: TableRow[] = [
  { id: "1",  name: "Component Library Theming Rollout Across Shared Design Tokens, Legacy Surface Patterns, and Cross-Team Visual Consistency Initiatives", agent: "EvoResolver",    agentIconType: "bot",        model: "GPT 5.4", created: "6 Jul 24, 22:10", status: { text: "Updating prompt",        duration: "26m 11s", type: "running"    }, chevron: "collapsed", indent: false, actions: "3icons" },
  { id: "2",  name: "Updating agent prompt for theme token migration", agent: "EvoResolver",    agentIconType: "bot",        model: "GPT 5.4", created: "6 Jul 24, 22:10", status: { text: "Updating prompt",        duration: "26m 11s", type: "running"    }, chevron: null,        indent: true,  actions: "4icons" },
  ...
  { id: "6",  name: "Updating agent prompt for WCAG contrast fixes",   agent: "EvoResolver",    agentIconType: "bot",        model: "GPT 5.4", created: "6 Jul 24, 22:10", status: { text: "Updating prompt",        duration: "8m 14s",  type: "running"                            }, chevron: null,        indent: true,  actions: "4icons" },
  ...
  { id: "9",  name: "Updating agent prompt for render path optimization", agent: "EvoResolver",    agentIconType: "bot",        model: "GPT 5.4", created: "6 Jul 24, 22:10", status: { text: "Updating prompt",        duration: "3m 22s",  type: "running"                            }, chevron: null,        indent: true,  actions: "4icons" },
  ...
  { id: "13", name: "Updating agent prompt for auth form validation states", agent: "EvoResolver",    agentIconType: "bot",        model: "GPT 5.4", created: "6 Jul 24, 22:10", status: { text: "Updating prompt",        duration: "6m 51s",  type: "running"                            }, chevron: null,        indent: true,  actions: "4icons" },
  ...
  { id: "17", name: "Updating agent prompt for chunk splitting strategy", agent: "EvoResolver",    agentIconType: "bot",        model: "GPT 5.4", created: "6 Jul 24, 22:10", status: { text: "Updating prompt",        duration: "4m 03s",  type: "running"                            }, chevron: null,        indent: true,  actions: "4icons" },
